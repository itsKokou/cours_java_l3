...
import ism.repositories.bd.impl.ClasseRepositoryImpl;
import ism.repositories.bd.impl.CoursRepositoryImpl;
import ism.repositories.bd.impl.FiliereRepositoryImpl;
import ism.repositories.bd.impl.ModuleRepositoryImpl;
import ism.repositories.bd.impl.NiveauRepositoryImpl;
import ism.repositories.bd.impl.ProfesseurRepositoryImpl;
import ism.repositories.bd.impl.SalleRepositoryImpl;
...
public class App {
    ...
    private static final Date dateDuJour = Date.valueOf(java.time.LocalDate.now());
    private static final Time heureActuelle = Time.valueOf(new SimpleDateFormat("HH:mm:ss").format(new java.util.Date()));
    private static DataBase dataBase = new MySql();

    private static ModuleRepository moduleRepository = new ModuleRepositoryImpl(dataBase);
    private static ModuleService moduleService = new ModuleServiceImpl(moduleRepository);

    private static NiveauRepository niveauRepository = new NiveauRepositoryImpl(dataBase);
    private static NiveauService niveauService = new NiveauServiceImpl(niveauRepository);

    private static FiliereRepository filiereRepository = new FiliereRepositoryImpl(dataBase);
    private static FiliereService filiereService = new FiliereServiceImpl(filiereRepository);

    private static SalleRepository salleRepository = new SalleRepositoryImpl(dataBase);
    private static SalleService salleService = new SalleServiceImpl(salleRepository);
    
    private static ClasseRepository classeRepository = new ClasseRepositoryImpl(dataBase);
    private static ClasseService classeService = new ClasseServiceImpl(classeRepository);
    
    private static ProfesseurRepository professeurRepository = new ProfesseurRepositoryImpl(dataBase);
    private static ProfesseurService professeurService = new ProfesseurServiceImpl(professeurRepository);
    
    private static CoursRepository coursRepository = new CoursRepositoryImpl(dataBase);
    private static CoursService coursService = new CoursServiceImpl(coursRepository);
            ...
            switch (choix) {
                ...
                //Gerer Classes
                    ...
                    do {
                        ...
                        switch (choix1) {
                            case 1:
                                //Ajout classe
                                ArrayList<Niveau> niveaux = niveauService.getAll();
                                ArrayList<Filiere> filieres = filiereService.getAll();
                                do {
                                    ...
                                    if (!classe.getModules().isEmpty()) {
                                        ...
                                        if (!classe.getModules().contains(module)) {
                                            ...
                                            if (confirmer("le retrait de ce module de cette classe")==1) {
                                                classeService.removeModule(classe.getId(), module.getId());
                                                clearScreen();
                ...
                case 3:
                    ...
                    if (classe==null) {
                        ...
                        clearScreen();
                        ArrayList<Module> modules = moduleService.getAll();
                        ...
                        if (module == null) {
                            ...
                            if (classe.getModules().contains(module)) {
                                System.out.println("Ce module a déjà été affecté à cette classe");
                            }else{
                                if (confirmer("l'ajout de ce module à cette classe")==1) {
                                    clearScreen();
                                    classeService.addModule(classe.getId(), module.getId());
                ...
                case 5:
                    ...
                    if (module==null) {
                        ...
                        ArrayList<Classe>classes = classeService.findClassesByModule(id);
                        if(classes.isEmpty()){
                    ...
                    do {
                        ...
                        switch (choix6) {
                            case 1:
                                ...
                                ArrayList<ClasseEnseignee> classesEnseignees = saisieClasseEnseignee();
                                if (confirmer("l'ajout du professeur")==1) {
                                    clearScreen();
                                    try {
                                        professeur = new Professeur(libelle, portable, classesEnseignees);
                            ...
                            case 4:
                                ...
                                professeur = professeurService.show( sc.nextInt());
                                sc.nextLine();
                                if(professeur==null){
                                    System.out.println("\nCe professeur n'existe pas !");
                                }else{
                                    ArrayList<Classe> classes = classeService.getAll();
                                    ...
                                    classe = classeService.show(sc.nextInt());
                                    sc.nextLine();
                                    if (classe == null) {
                                        System.out.println("\nCette Classe n'existe pas");
                                    } else {
                                        if (checkClasseInClassesEnseignees(classesEnseignees, classe)!=-1) {
                                            ...
                                            if(modules.isEmpty()){
                                                ...
                                                ArrayList<Module> modulesSaisis = saisieModulesEnseignes(classe);
                                                if (modulesSaisis.isEmpty()) {
                                                    ...
                                                    if (confirmer("l'affectation de la classe au professeur")==1) {
                                                        professeurService.addClasseEnseignee(professeur.getId(), classeEnseignee);
                                                        clearScreen();
                                ...
                                if (professeur==null) {
                                    ...
                                    if (classeEnseignee == null) {
                                        ...
                                        if (confirmer("le retrait de cette classe du professeur")==1) {
                                            professeurService.removeClasseEnseignee(classeEnseignee);
                                            clearScreen();
                            ...
                            case 6:
                                ...
                                if (professeur==null) {
                                    ...
                                    clearScreen();
                                    ArrayList<ClasseEnseignee> classeEnseignees = professeur.getClassesEnseignees();
                                    if (classeEnseignees.isEmpty()) {
                                        ...
                                        if (classeEnseignee == null) {
                                            ...
                                            ArrayList<Module> modules = classeService.show(classeEnseignee.getClasse().getId()).getModules();
                                            ArrayList<Module> modulesEnseignes = professeurService.findModulesEnseignesByClasse(classeEnseignee.getClasse().getId());
                                            int id2;
                                                    ...
                                                    if (module == null || !modules.contains(module) ) {
                                                        ...
                                                        if (modulesEnseignes.contains(module)) {
                                                            ...
                                                            if (confirmer("l'enseignement de ce module dans cette classe")==1) {
                                                                professeurService.addModuleEnseignee(classeEnseignee.getId(), module);
                                                                clearScreen();
                                        ...
                                        if (classeEnseignee == null) {
                                            ...
                                            if (module == null || !classeEnseignee.getModules().contains(module) ) {
                                                ...
                                                if (confirmer("l'annulation de l'enseignement de ce module dans cette classe")==1) {
                                                    professeurService.removeModuleEnseigne(classeEnseignee, module);
                                                    clearScreen();
                ...
                case 9:
                    ...
                    Time heureD = saisieHeureDebut(date);
                    if (heureD!=null) {
                        Time heureF = saisieHeureFin(heureD);
                        ...
                        if (module==null) {
                            ...
                            ArrayList<Professeur> professeurs = professeurService.findProfDisponibles(module, date, heureD, heureF);
                            if (professeurs.isEmpty()) {
                                ...
                                if(professeur==null || !professeurs.contains(professeur)){
                                    ...
                                    ArrayList<Classe> classes = classeService.findClasseDisponibles(module, professeur, date, heureD, heureF);
                                    classes.forEach(System.out::println);
                                    if (classes.isEmpty()) {
                                        System.out.println("\nAucune Classe disponible pour cet horaire de cours");
                                    } else {
                                        ArrayList<Classe> classesDuCours = saisieClassesDisponibles(classes);
                                        int nbrePlace = calculateNbrePlace(classesDuCours);
                                        int choixLieu;
                                        ...
                                        if (choixLieu==1) {
                                            ...
                                            ArrayList<Salle> salles = salleService.findSalleDisponibles(nbrePlace, date, heureD, heureF);
                                            if (salles.isEmpty()) {
                                                System.out.println("\nAucune Salle disponible pour ce de cours");
                                                do {
                                        ...
                                        if (choixFaireCours==1) {
                                            cours = new Cours(0,date, heureD, heureF, codeCours, module, professeur, salle, classesDuCours);
    ...
    public static int checkClasseInClassesEnseignees(ArrayList<ClasseEnseignee> classesEnseignees,Classe classe){
    ...
    public static ArrayList<Module> saisieModulesEnseignes(Classe classe){
        ArrayList<Module> modules = classe.getModules();
        ArrayList<Module> moduleSaisis = new ArrayList<>();
        ArrayList<Module> modulesEnseignes = professeurService.findModulesEnseignesByClasse(classe.getId());
    ...
    public static ArrayList<ClasseEnseignee> saisieClasseEnseignee(){
        ArrayList<ClasseEnseignee> classesEnseignees = new ArrayList<>();
        ArrayList<Classe> classes = classeService.getAll();
        int id;
        do {
            ClasseEnseignee classeEnseignee = new ClasseEnseignee();
                    ...
                    if (checkClasseInClassesEnseignees(classesEnseignees, classe)!=-1) {
                        ...
                        if(modules.isEmpty()){
                            ...
                            if (modulesSaisis.isEmpty()) {
                                ...
                                classeEnseignee.getModules().addAll(modulesSaisis);
                                // classeEnseignee.setModules(modulesSaisis);
    ...
    public static Time saisieHeureDebut(Date date){
        int succes = 0;
        Time heureD = null;
        if (date.equals(dateDuJour)) {
            if (heureActuelle.after(Time.valueOf("17:00:00"))) {
                ...
                do {
                    ...
                    heure=heure+":00";
                    try {
                        heureD = Time.valueOf(heure);
                        if(heureD.before(Time.valueOf("08:00:00")) || heureD.after(Time.valueOf("17:00:00"))){
                            System.out.println("\nL'heure de début doit être entre 08h et 17h");
                        }else{
                            if (heureD.before(heureActuelle)) {
    ...
    public static Time saisieHeureFin(Time heureD){
        int succes = 0;
        Time heureF = null;
        do {
            ...
            heure=heure+":00";
            try {
                heureF = Time.valueOf(heure);
                if(heureF.before(heureD) || heureF.after(Time.valueOf("21:00:00"))){
                    System.out.println("\nL'heure de fin doit être entre "+ heureD+ " et 21:00:00");
                }else{
                    long difference = (heureF.getTime() - heureD.getTime())/(60*1000);
                    if (difference<60) {
    ...
    public static ArrayList<Classe> saisieClassesDisponibles(ArrayList<Classe> classes){
        ArrayList<Classe> classesSaisies = new ArrayList<>();
        int id2;
            Niveau niveau = null;
            do {
    ...
    public static int calculateNbrePlace(ArrayList<Classe> classes){
        int nbrePlace=0;
